...
const Footer = () => {
  return (
    <footer className="border-t border-gray-300 w-full text-gray-700">
      <div className="container mx-auto px-6 flex flex-col items-center text-center space-y-6 md:flex-row md:justify-between md:text-left">
        ...
        <div className="flex items-center space-x-3">
          ...
          <span className="text-xl font-semibold text-gray-900">Attestation Manager</span>
        </div>
      ...
      <div className="mt-6 text-center text-gray-500 text-sm">
        © {new Date().getFullYear()} Attestation Manager. All rights reserved.
      </div>
    </footer>
  );
};
